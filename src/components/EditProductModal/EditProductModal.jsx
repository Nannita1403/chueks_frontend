          ...
          <VStack spacing={4} align="stretch">
            ...
            <HStack>
              <FormControl>
                ...
                <NumberInput
                  value={currentProduct.priceMin || 0}
                  onChange={(v) =>
                    handleChange({
              ...
              <FormControl>
                ...
                <NumberInput
                  value={currentProduct.priceMay || 0}
                  onChange={(v) =>
                    handleChange({
            ...
            <FormControl>
              ...
              <Input
                name="imgPrimary"
                value={currentProduct.imgPrimary || ""}
                onChange={handleChange}
              />
            </FormControl>
            ...
            <FormControl>
              ...
              <Input
                name="imgSecondary"
                value={currentProduct.imgSecondary || ""}
                onChange={handleChange}
              />
            </FormControl>
          </VStack>
